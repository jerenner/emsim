from emsim.networks.positional_encoding import RoPEEncoding2DFullLearnableFreqs
...
class SelfAttentionWithRoPE(nn.Module):
    def __init__(
        ...
        self.pos_encoding = RoPEEncoding2DFullLearnableFreqs(n_heads, d_model // n_heads)
