...
class MultilevelSelfAttentionBlockWithRoPE(nn.Module):
    ...
    def __init__(
        ...
        self.register_buffer("rope_spatial_base_theta", torch.tensor(rope_spatial_base_theta))
        self.register_buffer("rope_level_base_theta", torch.tensor(rope_level_base_theta))
